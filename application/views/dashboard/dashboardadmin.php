        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              <div class="card card-primary">
                <div class="card-header bg-primary">
                  <h3 class="card-title"><i class="fas fa-edit"></i> AKTIVITAS MEMBER</h3>
                      ...
                      foreach ($resultall as $row) { ?>
                        <tr>
                          ...
                          <td><?php
                              ...
                              ?><br /><small>pukul
                              <?php
                              $timestamp1 = strtotime($row['create_at']);
                              $newTime = date('H:i', $timestamp1);
                              echo $newTime;
                              ?></small>
                          </td>
                          <td><?= $row['user']; ?></td>
            ...
            <div class="col-lg-4">
              <div class="card card-primary">
                <div class="card-header bg-primary">
                  <h3 class="card-title m-0"><i class="fas fa-list-alt"></i> DAFTAR KELAYAKAN</h3>
                  <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                      <i class="fas fa-minus"></i>
                    </button>
              ...
              <div class="card card-primary">
                <div class="card-header bg-primary">
                  <h3 class="card-title m-0"><i class="fas fa-list-alt"></i> DAFTAR PERTANYAAN IDENTIFIKASI</h3>
                  <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                      <i class="fas fa-minus"></i>
                    </button>
                ...
                <div class="card-body">
                  <table class="table">
                    ...
                    <tbody>
                      <?php foreach ($identifikasi as $id) { ?>
                        <tr>
                          <td><?= $id['kode']; ?></td>
                          <td><?= $id['fakta']; ?></td>
                          <td><?= $id['bobot']; ?></td>
